                ...
                <?php if (is_user_logged_in()) { ?>
                  <div id="dropdown-user-profile" class="ddmenu">
                    ...
                    <ul>
                      ...
                      <li class="h"><a href="<?php echo esc_url(get_permalink( get_option('woocommerce_myaccount_page_id') )); ?>"><i class="fas fa-layer-group"></i> <?php echo esc_html__('My Dashboard','ibid'); ?></a></li>
