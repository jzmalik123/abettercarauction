            ...
            <header class="dokan-dashboard-header dokan-clearfix">
                <h1 class="entry-title">
                    ...
                    <?php if ( $_visibility === 'hidden' ) : ?>
                        <span class="dokan-right dokan-label dokan-label-default dokan-product-hidden-label"><i class="far fa-eye-slash"></i> <?php esc_html_e( 'Hidden', 'ibid' ); ?></span>
                    <?php endif; ?>
                </h1>
            </header><!-- .entry-header -->
                ...
                <?php if ( apply_filters( 'dokan_can_post', true ) ) : ?>
                    <?php if ( dokan_is_seller_enabled( get_current_user_id() ) ) : ?>
                        <form class="dokan-product-edit-form" role="form" method="post" id="post">
                                ...
                                <div class="content-half-part dokan-product-meta">
                                    ...
                                    <div id="dokan-product-title-area" class="dokan-form-group">
                                        ...
                                        dokan_post_input_box(
                                            ...
                                            'post_title',
                                            [
                                                'placeholder' => __( 'Product name..', 'ibid' ),
                                                'value'       => $post_title,
                                            ]
                                        );
                                        ?>
                                    ...
                                    <?php $product_types = apply_filters( 'dokan_product_types', [ 'simple' => __( 'Simple', 'ibid' ) ] ); ?>
                                    ...
                                    <?php if ( is_array( $product_types ) ) : ?>
                                        ...
                                        <?php else : ?>
                                            <div class="dokan-form-group">
                                                <label for="product_type" class="form-label"><?php esc_html_e( 'Product Type', 'ibid' ); ?> <i class="fas fa-question-circle tips" aria-hidden="true" data-title="<?php esc_html_e( 'Choose Variable if your product has multiple attributes - like sizes, colors, quality etc', 'ibid' ); ?>"></i></label>
                                    ...
                                    ?>
                                        <div class="content-half-part auction-checkbox">
                                            <label>
                                                <input type="checkbox" <?php if( $_product->is_type( 'auction' ) ) {echo esc_attr__('checked', 'ibid');} ?> class="ibid_is_auction _is_auction" name="_auction" id="_auction"> <?php esc_html_e( 'Auction', 'ibid' ); ?> <i class="fas fa-question-circle tips" aria-hidden="true" data-title="<?php esc_attr_e( 'Enable Auction for the current product', 'ibid' ); ?>"></i>
                                            </label>
                                        </div>
                                        ...
                                        <div class="dokan-form-group dokan-clearfix dokan-price-container">
                                            ...
                                            <div class="content-half-part sale-price">
                                                <label for="_sale_price" class="form-label">
                                                    ...
                                                    <a href="#" class="sale_schedule <?php echo $show_schedule ? 'dokan-hide' : ''; ?>"><?php esc_html_e( 'Schedule', 'ibid' ); ?></a>
                                        ...
                                        <div class="sale_price_dates_fields dokan-clearfix dokan-form-group <?php echo ( ! $show_schedule ) ? 'dokan-hide' : ''; ?>">
                                            <div class="content-half-part from">
                                                <div class="dokan-input-group">
                                                    ...
                                                    <input type="text" name="_sale_price_dates_from" class="dokan-form-control dokan-start-date" value="<?php echo esc_attr( $_sale_price_dates_from ); ?>" maxlength="10" pattern="[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])" placeholder="<?php esc_html_e( 'YYYY-MM-DD', 'ibid' ); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="content-half-part to">
                                                <div class="dokan-input-group">
                                                    ...
                                                    <input type="text" name="_sale_price_dates_to" class="dokan-form-control dokan-end-date" value="<?php echo esc_attr( $_sale_price_dates_to ); ?>" maxlength="10" pattern="[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])" placeholder="<?php esc_html_e( 'YYYY-MM-DD', 'ibid' ); ?>">
                                                </div>
                                            </div>
                                    ...
                                    <div class="dokan-form-group">
                                        <label for="product_tag_edit" class="form-label"><?php esc_html_e( 'Tags', 'ibid' ); ?></label>
                                        <?php
                                        ...
                                        $tags_placeholder = 'on' === $can_create_tags ? __( 'Select tags/Add tags', 'ibid' ) : __( 'Select product tags', 'ibid' );
                            ...
                            <input type="submit" name="dokan_update_product" id="publish" class="dokan-btn dokan-btn-theme dokan-btn-lg dokan-right" value="<?php esc_attr_e( 'Save Product', 'ibid' ); ?>"/>
