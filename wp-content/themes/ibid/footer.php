        ...
        <?php if ( class_exists( 'ReduxFrameworkPlugin' ) || class_exists( 'WooCommerce' ) ) { ?>
            <?php if (ibid_redux('ibid-enable-footer-top') == true) { ?>
                <div class="top-footer row">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8 left"><?php esc_html_e( 'Join Our Free Newsletter!', 'ibid' ); ?></div>
                            <div class="col-md-4">
                                <form name="myform" method="POST" class="woocommerce-product-search menu-search" action="/#wpcf7-f6999-o1">
									<div style="display: none;">
									<input type="hidden" name="_wpcf7" value="6999">
									<input type="hidden" name="_wpcf7_version" value="5.6.4">
									<input type="hidden" name="_wpcf7_locale" value="en_US">
									<input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f6999-o1">
									<input type="hidden" name="_wpcf7_container_post" value="0">
									<input type="hidden" name="_wpcf7_posted_data_hash" value="">
									</div>
                                    <input type="email"  name="your-email" class="search-field" maxlength="128" value="<?php echo esc_attr(get_search_query()); ?>" placeholder="<?php esc_attr_e('Enter your email', 'ibid'); ?>">
