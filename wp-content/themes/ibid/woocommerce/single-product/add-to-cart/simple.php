...
if ( $product->is_in_stock() ) : ?>
	...
	<form class="cart" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
		...
		<button type="submit" <?php echo wp_kses_post($add_to_cart_tooltip); ?> name="add-to-cart" value="<?php echo esc_attr( $product->get_id() ); ?>" class="single_add_to_cart_button button alt <?php echo esc_attr($add_to_cart_class); ?>"><i class="fas fa-shopping-basket"></i> <?php echo esc_html($add_to_cart); ?></button>
