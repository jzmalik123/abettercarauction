	...
	<div class="wcfm-collapse-content">
		...
		<div class="wcfm-container wcfm-top-element-container">
			...
			if( $product_id ) {
				...
				if( apply_filters( 'wcfm_is_allow_product_preview', true ) ) {
					if( $wcfm_products_single->post_status == 'publish' ) {
						...
						?>
						<span class="view_count"><span class="fas fa-eye text_tip" data-tip="<?php _e( 'Views', 'ibid' ); ?>"></span>
						<?php
						echo get_post_meta( $wcfm_products_single->ID, '_wcfm_product_views', true ) . '</span></a>';
					} else {
						echo '<a target="_blank" href="' . apply_filters( 'wcfm_product_preview_url', get_permalink( $wcfm_products_single->ID ) ) . '">';
						?>
						<span class="view_count"><span class="fas fa-eye text_tip" data-tip="<?php _e( 'Preview', 'ibid' ); ?>"></span>
						<?php
						echo '</a>';
					}
				}
			...
			if( $has_new = apply_filters( 'wcfm_add_new_product_sub_menu', true ) ) {
				echo '<a id="add_new_product_dashboard" class="add_new_wcfm_ele_dashboard text_tip" href="'.get_wcfm_edit_product_url().'" data-tip="' . __('Add New Product', 'ibid') . '"><span class="fas fa-cube"></span><span class="text">' . __( 'Add New', 'ibid') . '</span></a>';
			}
			...
			if( $product_id && !$wcfm_is_translated_product && apply_filters( 'wcfm_is_allow_duplicate_product', true ) && apply_filters( 'wcfm_is_allow_product_limit', true ) ) {
				if( WCFM_Dependencies::wcfmu_plugin_active_check() ) {
					echo '<a id="wcfm_product_duplicate" class="wcfm_product_duplicate add_new_wcfm_ele_dashboard text_tip" href="#" data-proid="'. $product_id .'" data-tip="' . __('Duplicate Product', 'ibid') . '"><span class="fas fa-copy"></span><span class="text">' . __( 'Duplicate', 'ibid') . '</span></a>';
				}
			}
				...
				if( apply_filters( 'wcfm_is_allow_featured_product', true ) ) {
					if( WCFM_Dependencies::wcfmu_plugin_active_check() ) {
						if( has_term( 'featured', 'product_visibility', $wcfm_products_single->ID ) ) {
							echo '<a id="wcfm_product_featured" class="wcfm_product_featured add_new_wcfm_ele_dashboard text_tip" href="#" data-featured="nofeatured" data-proid="'. $product_id .'" data-tip="' . __('No Featured', 'ibid') . '"><span class="fas fa-star-of-life"></span><span class="text">' . __( 'No Featured', 'ibid') . '</span></a>';
						} else {
							if( apply_filters( 'wcfm_has_featured_product_limit', true ) ) {
								echo '<a id="wcfm_product_featured" class="wcfm_product_featured add_new_wcfm_ele_dashboard text_tip" href="#" data-featured="featured" data-proid="'. $product_id .'" data-tip="' . __('Mark Featured', 'ibid') . '"><span class="fas fa-star"></span><span class="text">' . __( 'Mark Featured', 'ibid') . '</span></a>';
							}
						}
					}
				}
