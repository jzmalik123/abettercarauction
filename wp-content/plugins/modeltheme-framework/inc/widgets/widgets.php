    ...
    public function widget( $args, $instance ) {
        ...
        <div class="sidebar-social-networks">
            ...
            <?php if ( isset($ibid_redux['ibid_social_fb']) && $ibid_redux['ibid_social_fb'] != '' ) { ?>
                <li><a target="_blank" href="<?php echo esc_attr( $ibid_redux['ibid_social_fb'] ) ?>"><i class="fab fa-facebook"></i></a></li>
            <?php } ?>
            <?php if ( isset($ibid_redux['ibid_social_tw']) && $ibid_redux['ibid_social_tw'] != '' ) { ?>
                <li><a target="_blank" href="https://twitter.com/<?php echo esc_attr( $ibid_redux['ibid_social_tw'] ) ?>"><i class="fab fa-twitter"></i></a></li>
            <?php } ?>
            <?php if ( isset($ibid_redux['ibid_social_youtube']) && $ibid_redux['ibid_social_youtube'] != '' ) { ?>
                <li><a target="_blank" href="<?php echo esc_attr( $ibid_redux['ibid_social_youtube'] ) ?>"><i class="fab fa-youtube"></i></a></li>
            <?php } ?>
            <?php if ( isset($ibid_redux['ibid_social_pinterest']) && $ibid_redux['ibid_social_pinterest'] != '' ) { ?>
                <li><a target="_blank" href="<?php echo esc_attr( $ibid_redux['ibid_social_pinterest'] ) ?>"><i class="fab fa-pinterest"></i></a></li>
            <?php } ?>
            <?php if ( isset($ibid_redux['ibid_social_linkedin']) && $ibid_redux['ibid_social_linkedin'] != '' ) { ?>
                <li><a target="_blank" href="<?php echo esc_attr( $ibid_redux['ibid_social_linkedin'] ) ?>"><i class="fab fa-linkedin"></i></a></li>
            <?php } ?>
            <?php if ( isset($ibid_redux['ibid_social_skype']) && $ibid_redux['ibid_social_skype'] != '' ) { ?>
                <li><a target="_blank" href="<?php echo esc_attr( $ibid_redux['ibid_social_skype'] ) ?>"><i class="fab fa-skype"></i></a></li>
            <?php } ?>
            <?php if ( isset($ibid_redux['ibid_social_instagram']) && $ibid_redux['ibid_social_instagram'] != '' ) { ?>
                <li><a target="_blank" href="<?php echo esc_attr( $ibid_redux['ibid_social_instagram'] ) ?>"><i class="fab fa-instagram"></i></a></li>
            <?php } ?>
            <?php if ( isset($ibid_redux['ibid_social_dribbble']) && $ibid_redux['ibid_social_dribbble'] != '' ) { ?>
                <li><a target="_blank" href="<?php echo esc_attr( $ibid_redux['ibid_social_dribbble'] ) ?>"><i class="fab fa-dribbble"></i></a></li>
            <?php } ?>
            <?php if ( isset($ibid_redux['ibid_social_deviantart']) && $ibid_redux['ibid_social_deviantart'] != '' ) { ?>
                <li><a target="_blank" href="<?php echo esc_attr( $ibid_redux['ibid_social_deviantart'] ) ?>"><i class="fab fa-deviantart"></i></a></li>
            <?php } ?>
            <?php if ( isset($ibid_redux['ibid_social_digg']) && $ibid_redux['ibid_social_digg'] != '' ) { ?>
                <li><a target="_blank" href="<?php echo esc_attr( $ibid_redux['ibid_social_digg'] ) ?>"><i class="fab fa-digg"></i></a></li>
            <?php } ?>
            <?php if ( isset($ibid_redux['ibid_social_flickr']) && $ibid_redux['ibid_social_flickr'] != '' ) { ?>
                <li><a target="_blank" href="<?php echo esc_attr( $ibid_redux['ibid_social_flickr'] ) ?>"><i class="fab fa-flickr"></i></a></li>
            <?php } ?>
            <?php if ( isset($ibid_redux['ibid_social_stumbleupon']) && $ibid_redux['ibid_social_stumbleupon'] != '' ) { ?>
                <li><a target="_blank" href="<?php echo esc_attr( $ibid_redux['ibid_social_stumbleupon'] ) ?>"><i class="fab fa-stumbleupon"></i></a></li>
            <?php } ?>
            <?php if ( isset($ibid_redux['ibid_social_tumblr']) && $ibid_redux['ibid_social_tumblr'] != '' ) { ?>
                <li><a target="_blank" href="<?php echo esc_attr( $ibid_redux['ibid_social_tumblr'] ) ?>"><i class="fab fa-tumblr"></i></a></li>
            <?php } ?>
            <?php if ( isset($ibid_redux['ibid_social_vimeo']) && $ibid_redux['ibid_social_vimeo'] != '' ) { ?>
                <li><a target="_blank" href="<?php echo esc_attr( $ibid_redux['ibid_social_vimeo'] ) ?>"><i class="fab fa-vimeo-square"></i></a></li>
            <?php } ?>
            </ul>
        </div>
    ...
    public function widget( $args, $instance ) {
        ...
        <div class="sidebar-social-networks address-social-links">
            ...
            <div class="contact-details">
                <?php if($ibid_redux['ibid_contact_address']) { ?><span><i class="fas fa-map-marker-alt"></i><?php echo esc_attr($ibid_redux['ibid_contact_address']); ?></span> <?php } ?>
                <?php if($ibid_redux['ibid_contact_email']) { ?><span><i class="far fa-envelope"></i><?php echo esc_attr($ibid_redux['ibid_contact_email']); ?></span> <?php } ?>
                <?php if($ibid_redux['ibid_contact_phone']) { ?><span><i class="fas fa-phone"></i><?php echo esc_attr($ibid_redux['ibid_contact_phone']); ?></span> <?php } ?>
            </div>
    ...
    public function widget( $args, $instance ) {
        ...
        $myContent .= '<div class="slider_holder relative">';
            $myContent .= '<div class="slider_navigation absolute">';
                $myContent .= '<a class="btn prev pull-left"><i class="fas fa-angle-left"></i></a>';
                $myContent .= '<a class="btn next pull-right"><i class="fas fa-angle-right"></i></a>';
            $myContent .= '</div>';
