...
function ibid_posts_calendar_shortcode($params, $content) {
    ...
    $posts_calendar .= '<div class="latest-posts animateIn" data-animate="'.$animation.'">';
        $posts_calendar .= '<h3 class=""><i class="fas fa-calendar"></i>'.$title.'</h3>';
...
function ibid_featured_post_shortcode($params, $content) {
    ...
    $featured_post .= '<div class="latest-videos animateIn" data-animate="'.$animation.'">';
        ...
        $featured_post .= '<div class="video-title">';
            ...
            $featured_post .= '<span class="post-date"><i class="fas fa-calendar"></i>'.get_the_date('', $postid ).'</span>';
            $featured_post .= '</div>';
...
function ibid_alert_shortcode($params, $content) {
    ...
    $content .= '<div role="alert" class="alert alert-'.$alert_style.' animateIn" data-animate="'.$animation.'">';
        if ($alert_dismissible == 'yes') {
            $content .= '<button aria-label="'.esc_attr__('Close', 'modeltheme').'" data-dismiss="alert" class="close" type="button"><span aria-hidden="true"><i class="fas fa-times"></i></span></button>';
        }
        $content .= $alert_text;
    $content .= '</div>';
    return $content;
        ...
        if($thumbnail_src) { 
            ...
            $content .= '<div class="item-description absolute">';
                $content .= '<div class="holder-top">';
                    $content .= '<a class="ibid-trigger" href="#"><i class="fas fa-expand"></i></a>';
                    $content .= '<a href="'.get_the_permalink($portfolio->ID).'"><i class="fas fa-plus"></i></a>';
                $content .= '</div>';
            ...
            $content .= '<div class="ibid-quick-view portfolio-shortcode high-padding post-'.$portfolio->ID.'">';
                $content .= '<div class="ibid-slider-wrapper">';
                    ...
                    $content .= '<ul class="ibid-slider-navigation">';
                        $content .= '<li><a class="ibid-next" href="#0"><i class="fas fa-angle-left"></i></a></li>';
                        $content .= '<li><a class="ibid-prev" href="#0"><i class="fas fa-angle-right"></i></a></li>';
                    $content .= '</ul>';
                $content .= '</div>';
                ...
                $content .= '</div>';
                $content .= '<a href="#0" class="ibid-close"><i class="fas fa-times"></i></a>';
            $content .= '</div>';
        $content .= '</article>';
    }
    ...
    extract( shortcode_atts( 
        ...
        $content .= '<div class="sidebar-social-networks vc_social-networks widget_social_icons animateIn vc_row" data-animate="'.$animation.'">';
            ...
            if ( isset($facebook) && $facebook != '' ) {
                $content .= '<li><a href="'.esc_attr( $facebook ).'"><i class="fab fa-facebook"></i></a></li>';
            }
            if ( isset($twitter) && $twitter != '' ) {
                $content .= '<li><a href="'.esc_attr( $twitter ).'"><i class="fab fa-twitter"></i></a></li>';
            }
            if ( isset($pinterest) && $pinterest != '' ) {
                $content .= '<li><a href="'.esc_attr( $pinterest ).'"><i class="fab fa-pinterest"></i></a></li>';
            }
            if ( isset($youtube) && $youtube != '' ) {
                $content .= '<li><a href="'.esc_attr( $youtube ).'"><i class="fab fa-youtube"></i></a></li>';
            }
            if ( isset($instagram) && $instagram != '' ) {
                $content .= '<li><a href="'.esc_attr( $instagram ).'"><i class="fab fa-instagram"></i></a></li>';
            }
            if ( isset($linkedin) && $linkedin != '' ) {
                $content .= '<li><a href="'.esc_attr( $linkedin ).'"><i class="fab fa-linkedin"></i></a></li>';
            }
            if ( isset($skype) && $skype != '' ) {
                $content .= '<li><a href="skype:'.esc_attr( $skype ).'?call"><i class="fab fa-skype"></i></a></li>';
            }
            if ( isset($googleplus) && $googleplus != '' ) {
                $content .= '<li><a href="'.esc_attr( $googleplus ).'"><i class="fab fa-google-plus"></i></a></li>';
            }
            if ( isset($dribbble) && $dribbble != '' ) {
                $content .= '<li><a href="'.esc_attr( $dribbble ).'"><i class="fab fa-dribbble"></i></a></li>';
            }
            if ( isset($deviantart) && $deviantart != '' ) {
                $content .= '<li><a href="'.esc_attr( $deviantart ).'"><i class="fab fa-deviantart"></i></a></li>';
            }
            if ( isset($digg) && $digg != '' ) {
                $content .= '<li><a href="'.esc_attr( $digg ).'"><i class="fab fa-digg"></i></a></li>';
            }
            if ( isset($flickr) && $flickr != '' ) {
                $content .= '<li><a href="'.esc_attr( $flickr ).'"><i class="fab fa-flickr"></i></a></li>';
            }
            if ( isset($stumbleupon) && $stumbleupon != '' ) {
                $content .= '<li><a href="'.esc_attr( $stumbleupon ).'"><i class="fab fa-stumbleupon"></i></a></li>';
            }
            if ( isset($tumblr) && $tumblr != '' ) {
                $content .= '<li><a href="'.esc_attr( $tumblr ).'"><i class="fab fa-tumblr"></i></a></li>';
            }
            if ( isset($vimeo) && $vimeo != '' ) {
                $content .= '<li><a href="'.esc_attr( $vimeo ).'"><i class="fab fa-vimeo-square"></i></a></li>';
            }
            $content .= '</ul>';
        $content .= '</div>';
        return $content;
        ...
        $members = get_posts($args_members);
            foreach ($members as $member) {
                ...
                if($metabox_facebook_profile) {
                    $profil_fb = '<a target="_new" href="'. $metabox_facebook_profile .'" class="member01_profile-facebook"> <i class="fab fa-facebook" aria-hidden="true"></i></a> ';
                }

                if($metabox_twitter_profile) {
                    $profil_tw = '<a target="_new" href="https://twitter.com/'. $metabox_twitter_profile .'" class="member01_profile-twitter"> <i class="fab fa-twitter" aria-hidden="true"></i></a> ';
                }

                if($metabox_linkedin_profile) {
                    $profil_in = '<a target="_new" href="'. $metabox_linkedin_profile .'" class="member01_profile-linkedin"> <i class="fab fa-linkedin" aria-hidden="true"></i> </a> ';
                }

                if($metabox_vimeo_url) {
                    $profil_vi = '<a target="_new" href="'. $metabox_vimeo_url .'" class="member01_vimeo_url"> <i class="fab fa-vimeo" aria-hidden="true"></i> </a> ';
                }
                        ...
                        if($style_type != "style_v2") {
                            ...
                            if ( class_exists( 'WooCommerce_simple_auction' ) ) {
                                  ...
                                  if( $product->post_type !== 'auction' ) {
                                    if ($meta_auction_closed == '') {
                                      if ($meta_auction_current_bid) {
                                        $shortcode_content .= '<span class="before-text"><i class="fas fa-gavel"></i>'.esc_html__('Bid: ','modeltheme').'</span><span>'.wc_price($meta_auction_current_bid).'</span>';
                                      }else if($meta_auction_start_price){
                                        $shortcode_content .= '<span class="before-text"><i class="fas fa-gavel"></i>'.esc_html__('Bid: ','modeltheme').'</span><span>'.wc_price($meta_auction_start_price).'</span>';
                                      }
                                ...
                                $shortcode_content .= '<span class="align-right">'.$city.'</span><span class="before-text align-right"><i class="fas fa-map-marker-alt"></i>'.esc_html__('Area:','modeltheme').'</span>';
                            $shortcode_content .= '</div>';
                        }
                        $shortcode_content .= '</div>';
