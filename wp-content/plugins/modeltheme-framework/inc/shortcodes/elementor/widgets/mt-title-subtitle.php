...
class ibid_heading_title_subtitle_widget extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__( 'Title/Subtitle Text Color', 'modeltheme' ),
			]
		);
		$this->add_control(
			'delimitator_color',
			[
				'type' => \Elementor\Controls_Manager::COLOR,
				'label' => esc_html__( 'Choose Delimitator color', 'modeltheme' ),
			]
		);
	...
	protected function render() {
		...
		$content = '<div class="title-subtile-holder">';
		    $content .= '<h2 class="section-title '.$title_style.' "style="color: '.$title_color.'!important;">'.$title.'</h2>';
		    ...
		    $content .= '<div class="section-subtitle" style="color: '.$title_color.'!important;">'.$subtitle.'</div>';
		$content .= '</div>';
		echo  $content;
	}
